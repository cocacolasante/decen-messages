...
import CurrentSentMessage from '../components/CurrentSentMessage'
...
const AllSentMessages = () => {
  ...
  return (
    ...
    <div id="content" className='recent-messages-container'>
        <div className='recent-messages-container2'>
            <ul className='messages-list'>
                <h4 className='recent-messages-heading'>Recent Sent Messages</h4>
    ...
    <div>
          <CurrentSentMessage messageNumber={readMessage} />
        </div>
    </>
  )
}
